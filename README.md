...
| KPI | Description |
|-----|-------------|
| CTR | Click Through Rate - Ad attractiveness |
| CVR | Conversion Rate - Funnel effectiveness |
| IPM | Installs Per Mille - Gaming effectiveness |
| ROAS | Return on Ad Spend - Economic return |
...
### `src/hack_en.py`
- `compute_fatigue()`: Detects when creatives lose effectiveness
